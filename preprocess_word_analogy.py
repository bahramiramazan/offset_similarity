...
def pre_process():
	...
	analogy_relation_classification_data['test'].extend(data_special)
	...
	file='essential_files/semeval_2012.json'
	# print('all_relation_dic',all_relation_dic)
	# print('train_semeval_re',len(train_semeval_re))
	# print('test_semeval_re',len(test_semeval_re))
